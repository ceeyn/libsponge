...
tests/CMakeFiles/tcp_parser.dir/tcp_parser.cc.o: ../tests/tcp_parser.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/tcp_parser.dir/tcp_parser.cc.o"
	cd /sponge/build/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/tcp_parser.dir/tcp_parser.cc.o -c /sponge/tests/tcp_parser.cc
...
tests/CMakeFiles/tcp_parser.dir/tcp_parser.cc.i: cmake_force
	...
	cd /sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /sponge/tests/tcp_parser.cc > CMakeFiles/tcp_parser.dir/tcp_parser.cc.i
...
tests/CMakeFiles/tcp_parser.dir/tcp_parser.cc.s: cmake_force
	...
	cd /sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /sponge/tests/tcp_parser.cc -o CMakeFiles/tcp_parser.dir/tcp_parser.cc.s
...
tests/tcp_parser: tests/CMakeFiles/tcp_parser.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable tcp_parser"
	cd /sponge/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/tcp_parser.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/tcp_parser.dir/clean:
	cd /sponge/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/tcp_parser.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/tcp_parser.dir/clean

tests/CMakeFiles/tcp_parser.dir/depend:
	cd /sponge/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /sponge /sponge/tests /sponge/build /sponge/build/tests /sponge/build/tests/CMakeFiles/tcp_parser.dir/DependInfo.cmake --color=$(COLOR)
