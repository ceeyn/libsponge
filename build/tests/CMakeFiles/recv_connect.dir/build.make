...
tests/CMakeFiles/recv_connect.dir/recv_connect.cc.o: ../tests/recv_connect.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/recv_connect.dir/recv_connect.cc.o"
	cd /sponge/build/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/recv_connect.dir/recv_connect.cc.o -c /sponge/tests/recv_connect.cc
...
tests/CMakeFiles/recv_connect.dir/recv_connect.cc.i: cmake_force
	...
	cd /sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /sponge/tests/recv_connect.cc > CMakeFiles/recv_connect.dir/recv_connect.cc.i
...
tests/CMakeFiles/recv_connect.dir/recv_connect.cc.s: cmake_force
	...
	cd /sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /sponge/tests/recv_connect.cc -o CMakeFiles/recv_connect.dir/recv_connect.cc.s
...
tests/recv_connect: tests/CMakeFiles/recv_connect.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable recv_connect"
	cd /sponge/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/recv_connect.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/recv_connect.dir/clean:
	cd /sponge/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/recv_connect.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/recv_connect.dir/clean

tests/CMakeFiles/recv_connect.dir/depend:
	cd /sponge/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /sponge /sponge/tests /sponge/build /sponge/build/tests /sponge/build/tests/CMakeFiles/recv_connect.dir/DependInfo.cmake --color=$(COLOR)
