...
tests/CMakeFiles/recv_close.dir/recv_close.cc.o: ../tests/recv_close.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/recv_close.dir/recv_close.cc.o"
	cd /sponge/build/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/recv_close.dir/recv_close.cc.o -c /sponge/tests/recv_close.cc
...
tests/CMakeFiles/recv_close.dir/recv_close.cc.i: cmake_force
	...
	cd /sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /sponge/tests/recv_close.cc > CMakeFiles/recv_close.dir/recv_close.cc.i
...
tests/CMakeFiles/recv_close.dir/recv_close.cc.s: cmake_force
	...
	cd /sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /sponge/tests/recv_close.cc -o CMakeFiles/recv_close.dir/recv_close.cc.s
...
tests/recv_close: tests/CMakeFiles/recv_close.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable recv_close"
	cd /sponge/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/recv_close.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/recv_close.dir/clean:
	cd /sponge/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/recv_close.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/recv_close.dir/clean

tests/CMakeFiles/recv_close.dir/depend:
	cd /sponge/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /sponge /sponge/tests /sponge/build /sponge/build/tests /sponge/build/tests/CMakeFiles/recv_close.dir/DependInfo.cmake --color=$(COLOR)
