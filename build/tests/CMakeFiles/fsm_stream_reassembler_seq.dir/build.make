...
tests/CMakeFiles/fsm_stream_reassembler_seq.dir/fsm_stream_reassembler_seq.cc.o: ../tests/fsm_stream_reassembler_seq.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object tests/CMakeFiles/fsm_stream_reassembler_seq.dir/fsm_stream_reassembler_seq.cc.o"
	cd /sponge/build/tests && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/fsm_stream_reassembler_seq.dir/fsm_stream_reassembler_seq.cc.o -c /sponge/tests/fsm_stream_reassembler_seq.cc
...
tests/CMakeFiles/fsm_stream_reassembler_seq.dir/fsm_stream_reassembler_seq.cc.i: cmake_force
	...
	cd /sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /sponge/tests/fsm_stream_reassembler_seq.cc > CMakeFiles/fsm_stream_reassembler_seq.dir/fsm_stream_reassembler_seq.cc.i
...
tests/CMakeFiles/fsm_stream_reassembler_seq.dir/fsm_stream_reassembler_seq.cc.s: cmake_force
	...
	cd /sponge/build/tests && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /sponge/tests/fsm_stream_reassembler_seq.cc -o CMakeFiles/fsm_stream_reassembler_seq.dir/fsm_stream_reassembler_seq.cc.s
...
tests/fsm_stream_reassembler_seq: tests/CMakeFiles/fsm_stream_reassembler_seq.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/sponge/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable fsm_stream_reassembler_seq"
	cd /sponge/build/tests && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/fsm_stream_reassembler_seq.dir/link.txt --verbose=$(VERBOSE)
...
tests/CMakeFiles/fsm_stream_reassembler_seq.dir/clean:
	cd /sponge/build/tests && $(CMAKE_COMMAND) -P CMakeFiles/fsm_stream_reassembler_seq.dir/cmake_clean.cmake
.PHONY : tests/CMakeFiles/fsm_stream_reassembler_seq.dir/clean

tests/CMakeFiles/fsm_stream_reassembler_seq.dir/depend:
	cd /sponge/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /sponge /sponge/tests /sponge/build /sponge/build/tests /sponge/build/tests/CMakeFiles/fsm_stream_reassembler_seq.dir/DependInfo.cmake --color=$(COLOR)
